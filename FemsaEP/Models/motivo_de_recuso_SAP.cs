...
namespace FemsaEP.Models
{
    ...
    public partial class motivo_de_recuso_SAP
    {
        public motivo_de_recuso_SAP()
        {
            this.cliente_SAP = new HashSet<cliente_SAP>();
        }
    
        public Nullable<decimal> MANDT { get; set; }
        public decimal ZCODMOTIV { get; set; }
        public string ZNOMMOTIV { get; set; }
        public string ZDESACTIV { get; set; }
        public Nullable<decimal> ZCODMOTI2 { get; set; }
